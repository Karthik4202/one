...
<header>
  <div class="container header-inner">
    ...
    <div class="brand"><i class="fas fa-moon"></i><span>VoidMarket</span></div>
    <nav>
    ...
    <div class="header-actions">
      ...
      <button class="icon-btn" id="wishlistBtn"><i class="far fa-heart"></i><span class="count" id="wishCount">0</span></button>
      <button class="icon-btn" id="cartBtn"><i class="fas fa-bag-shopping"></i><span class="count" id="cartCount">0</span></button>
      <button class="icon-btn" id="accountBtn"><i class="far fa-user"></i></button>
    </div>
  </div>
  ...
  <section class="hero">
    <div class="container">
      <div class="hero-content">
        <div style="display:inline-flex;gap:6px;background:var(--surface);padding:4px 14px;border-radius:40px;font-size:11px;font-weight:600;color:var(--accent);margin-bottom:12px;border:1px solid var(--border);"><i class="fas fa-circle" style="font-size:8px;"></i> live inventory</div>
        <h1>Dark matter <i>·</i> <br>minimal edge</h1>
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;">
          <button class="btn btn-primary" onclick="document.getElementById('products').scrollIntoView({behavior:'smooth'})"><i class="fas fa-arrow-right"></i> Explore</button>
          <button class="btn btn-dark" onclick="document.getElementById('deals').scrollIntoView({behavior:'smooth'})"><i class="fas fa-bolt"></i> Flash deals</button>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section" id="deals">
    <div class="container">
      ...
      <div class="deal-card">
        ...
        <div class="deal-body">
          <span class="deal-tag"><i class="fas fa-bolt"></i> 36h left</span>
          ...
          <button class="btn btn-primary" onclick="addToCart(9)"><i class="fas fa-cart-plus"></i> Grab deal</button>
        </div>
      </div>
    </div>
  </section>
...
<footer>
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand"><div class="brand"><i class="fas fa-moon"></i><span>VoidMarket</span></div><p>A dark‑themed commerce experiment with local state, wishlist, orders and real‑time inventory pulses.</p><div class="social"><a href="#"><i class="fab fa-instagram"></i></a><a href="#"><i class="fab fa-x-twitter"></i></a><a href="#"><i class="fab fa-github"></i></a></div></div>
...
<aside class="drawer" id="cartDrawer">
  <div class="drawer-head"><h2><i class="fas fa-bag-shopping"></i> Cart</h2><button class="close" onclick="closePanels()"><i class="fas fa-times"></i></button></div>
...
<div class="modal-wrap" id="modalWrap">
  <div class="modal">
    <div class="modal-head"><h2 id="modalTitle">Void</h2><button class="close" onclick="closeModal()"><i class="fas fa-times"></i></button></div>
